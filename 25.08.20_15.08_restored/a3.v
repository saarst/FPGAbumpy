...
//lpm_constant CBX_AUTO_BLACKBOX="ALL" ENABLE_RUNTIME_MOD="YES" INSTANCE_NAME="a3" LPM_CVALUE=00000000 LPM_WIDTH=32 result
...
module  a3_lpm_constant_poa
	...
	defparam
		mgl_prim1.cvalue = 32'd100,
		mgl_prim1.is_data_in_ram = 0,
		mgl_prim1.is_readable = 0,
		mgl_prim1.node_name = 1630732288,
...
module a3 (
	...
	a3_lpm_constant_poa	a3_lpm_constant_poa_component (
				.result (sub_wire0));
