...
//lpm_constant CBX_AUTO_BLACKBOX="ALL" ENABLE_RUNTIME_MOD="YES" INSTANCE_NAME="NONE" LPM_CVALUE=00000000 LPM_WIDTH=32 result
...
module  const_need_lpm_constant_l1b
	( 
	result) ;
	output   [31:0]  result;
...
endmodule //const_need_lpm_constant_l1b
//VALID FILE
...
module const_need (
	...
	const_need_lpm_constant_l1b	const_need_lpm_constant_l1b_component (
				.result (sub_wire0));
