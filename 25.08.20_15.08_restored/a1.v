...
//lpm_constant CBX_AUTO_BLACKBOX="ALL" ENABLE_RUNTIME_MOD="YES" INSTANCE_NAME="a1" LPM_CVALUE=00000001 LPM_WIDTH=32 result
...
module  a1_lpm_constant_ooa
	...
	defparam
		mgl_prim1.cvalue = 32'h200,
		mgl_prim1.is_data_in_ram = 0,
		mgl_prim1.is_readable = 0,
		mgl_prim1.node_name = 1630601216,
...
module a1 (
	...
	a1_lpm_constant_ooa	a1_lpm_constant_ooa_component (
				.result (sub_wire0));
